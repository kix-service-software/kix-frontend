...
export class NotesSocketListener extends SocketListener {

    public static getInstance(): NotesSocketListener {
        if (!NotesSocketListener.INSTANCE) {
            NotesSocketListener.INSTANCE = new NotesSocketListener();
        }

        return NotesSocketListener.INSTANCE;
    }

    private static INSTANCE: NotesSocketListener = null;
