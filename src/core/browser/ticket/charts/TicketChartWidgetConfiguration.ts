...
import { TicketProperty, KIXObjectLoadingOptions, ChartComponentConfiguration } from "../../../model";
import { IConfiguration, ConfigurationType, ConfigurationDefinition } from "../../../model/configuration";
