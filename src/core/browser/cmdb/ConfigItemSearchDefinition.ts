...
import {
    KIXObjectType, ConfigItemProperty, FilterCriteria, FilterDataType,
    FilterType, GeneralCatalogItem, VersionProperty, KIXObjectLoadingOptions,
    DataType, AttributeDefinition, Organisation, Contact, InputDefinition, ConfigItem,
