...
import { ConfigItemProperty, ChartComponentConfiguration } from "../../../model";
import { ConfigurationDefinition, IConfiguration, ConfigurationType } from "../../../model/configuration";
