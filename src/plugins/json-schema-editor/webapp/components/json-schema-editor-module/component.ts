...
import { JSONSchemaEditorContext } from '../../core';
...
class Component extends AbstractMarkoComponent<ComponentState> {
    ...
    public async onMount(): Promise<void> {
        const context = await ContextService.getInstance().getContext<JSONSchemaEditorContext>(
            JSONSchemaEditorContext.CONTEXT_ID
        );
