...
import { JSONSchemaEditorContext } from "./JSONSchemaEditorContext";

export class UIModule implements IUIModule {

    public name: string = 'JSONSchemaEditorUIModule';
    ...
    private registerContexts(): void {
        const jsonContext = new ContextDescriptor(
            JSONSchemaEditorContext.CONTEXT_ID, [KIXObjectType.ANY],
            ContextType.MAIN, ContextMode.DASHBOARD,
            false, 'json-schema-editor-module', ['json'], JSONSchemaEditorContext
        );
        ContextService.getInstance().registerContext(jsonContext);
    }
}
