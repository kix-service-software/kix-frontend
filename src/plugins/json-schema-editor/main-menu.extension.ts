...
export class Extension implements IMainMenuExtension {
    ...
    public mainContextId: string = JSONSchemaEditorContext.CONTEXT_ID;

    public contextIds: string[] = [JSONSchemaEditorContext.CONTEXT_ID];

    public primaryMenu: boolean = true;

    public icon: string = "kix-icon-edit";

    public text: string = "Translatable#JSON Editor";
