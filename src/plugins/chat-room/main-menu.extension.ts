...
import { ChatRoomContext } from './webapp/core/ChatRoomContext';

export class Extension implements IMainMenuExtension {

    public mainContextId: string = ChatRoomContext.CONTEXT_ID;

    public contextIds: string[] = [ChatRoomContext.CONTEXT_ID];

    public primaryMenu: boolean = true;

    public icon: string = "kix-icon-cti";

    public text: string = "Translatable#Chat";
