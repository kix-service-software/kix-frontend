...
export class UIModule implements IUIModule {
    ...
    public name: string = 'ChatUIModule';
    ...
    private registerContexts(): void {
        const context = new ContextDescriptor(
            ChatRoomContext.CONTEXT_ID, [KIXObjectType.ANY],
            ContextType.MAIN, ContextMode.DASHBOARD,
            false, 'chat-room-module', ['chat'], ChatRoomContext
        );
        ContextService.getInstance().registerContext(context);
    }
}
