...
export enum TicketEvent {
    ...
    MARK_TICKET_AS_SEEN = 'MARK_TICKET_AS_SEEN',
    ...
    REMOVE_ARTICLE_ATTACHMENT_DOWNLOADS = 'REMOVE_ARTICLE_ATTACHMENT_DOWNLOADS',
    ARTICLE_ATTACHMENT_DOWNLOADS_REMOVED = 'ARTICLE_ATTACHMENT_DOWNLOADS_REMOVED',
