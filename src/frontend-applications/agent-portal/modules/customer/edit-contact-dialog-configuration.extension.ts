...
class Extension extends KIXExtension implements IConfigurationExtension {
    ...
    public async getFormConfigurations(): Promise<IConfiguration[]> {
        ...
        const formConfiguration = new FormConfiguration(
            formId, 'Edit Contact', [], KIXObjectType.CONTACT, true, FormContext.EDIT
        );

        const contactPageConfiguration = new FormPageConfiguration(
            'contact-edit-form-page', 'Translatable#Contact Information',
        );
        ...
        const emailGroup = new FormGroupConfiguration(
            'contact-edit-form-group-email', 'Translatable#Email'
        );
