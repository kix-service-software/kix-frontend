...
describe('FormValue Binding', () => {
    ...
    describe('Check form value property binding', () => {
        ...
        it('Should have binding for form value properties', () => {
            ...
            expect(formValue['bindings'].length).equals(14);
        });
        ...
        it('Should have binding for defaultValue', () => {
            const binding = formValue['bindings'].find((b) => b.property === FormValueProperty.DEFAULT_VALUE);
            expect(binding).exist;
        });
