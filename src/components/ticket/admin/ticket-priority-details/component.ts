...
import { TicketPriorityDetailsContext, TicketPriorityDetailsContextConfiguration } from '@kix/core/dist/browser/ticket';
import { KIXObjectType, TicketPriority, WidgetType } from '@kix/core/dist/model';
