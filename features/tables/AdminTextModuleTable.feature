...
Feature: Als Nutzer möchte ich eine korrekte Standardkonfiguration für eine Tabelle erhalten
    ...
    Scenario Outline: Tabelle mit korrekter Spalte <column>
        ...
        Examples:
            ...
            | 'Name'       | 1        | 1          | 0          | 200   | 1        | 1        | 0        | 'STRING'   | 1           | 0          | 'TextModule' |
            | 'Keywords'   | 1        | 1          | 0          | 250   | 1        | 1        | 0        | 'STRING'   | 1           | 0          | 'TextModule' |
            | 'Language'   | 1        | 1          | 1          | 200   | 1        | 1        | 0        | 'STRING'   | 1           | 0          | 'TextModule' |
            | 'Comment'    | 1        | 1          | 0          | 350   | 1        | 1        | 0        | 'STRING'   | 1           | 0          | 'TextModule' |
            | 'ValidID'    | 1        | 1          | 1          | 150   | 1        | 1        | 0        | 'STRING'   | 1           | 0          | 'TextModule' |
            | 'CreateTime' | 1        | 1          | 0          | 150   | 1        | 1        | 0        | 'DATETIME' | 1           | 0          | 'TextModule' |
            | 'CreateBy'   | 1        | 1          | 0          | 150   | 1        | 1        | 0        | 'STRING'   | 1           | 0          | 'TextModule' |
            | 'ChangeTime' | 1        | 1          | 0          | 150   | 1        | 1        | 0        | 'DATETIME' | 1           | 0          | 'TextModule' |
            | 'ChangeBy'   | 1        | 1          | 0          | 150   | 1        | 1        | 0        | 'STRING'   | 1           | 0          | 'TextModule' |