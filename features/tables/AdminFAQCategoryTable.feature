...
Feature: Als Nutzer möchte ich eine korrekte Standardkonfiguration für eine Tabelle erhalten
    ...
    Scenario Outline: Tabelle mit korrekter Spalte <column>
        ...
        Examples:
            ...
            | 'CreateBy'   | 1        | 1          | 0          | 150   | 1        | 1        | 0        | 'STRING'   | 1           | 0          | 'FAQCategory' |
            | 'ChangeTime' | 1        | 1          | 0          | 150   | 1        | 1        | 0        | 'DATETIME' | 1           | 0          | 'FAQCategory' |
            | 'ChangeBy'   | 1        | 1          | 0          | 150   | 1        | 1        | 0        | 'STRING'   | 1           | 0          | 'FAQCategory' |