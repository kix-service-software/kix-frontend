...
Feature: Als Nutzer möchte ich eine korrekte Standardkonfiguration für eine Tabelle erhalten
    ...
    Scenario Outline: Tabelle mit korrekter Spalte <column>
        ...
        Examples:
            ...
            | 'Name'       | 1        | 1          | 0          | 200   | 1        | 1        | 0        | 'STRING'   | 1           | 0          | 'TicketState' |
            | 'ICON'       | 0        | 0          | 0          | 41    | 0        | 0        | 1        | 'STRING'   | 0           | 0          | 'TicketState' |
            | 'TypeName'   | 1        | 1          | 1          | 150   | 1        | 1        | 0        | 'STRING'   | 1           | 0          | 'TicketState' |
            | 'Comment'    | 1        | 1          | 0          | 350   | 1        | 1        | 0        | 'STRING'   | 1           | 0          | 'TicketState' |
            | 'ValidID'    | 1        | 1          | 1          | 150   | 1        | 1        | 0        | 'STRING'   | 1           | 0          | 'TicketState' |
            | 'ChangeTime' | 1        | 1          | 0          | 150   | 1        | 1        | 0        | 'DATETIME' | 1           | 0          | 'TicketState' |
            | 'ChangeBy'   | 1        | 1          | 0          | 150   | 1        | 1        | 0        | 'STRING'   | 1           | 0          | 'TicketState' |