...
Feature: Als Nutzer möchte ich eine korrekte Standardkonfiguration für eine Tabelle erhalten
    ...
    Scenario Outline: Tabelle mit korrekter Spalte <column>
        ...
        Examples:
            ...
            | 'Name'       | 1        | 1          | 0          | 300   | 1        | 1        | 0        | 'STRING'   | 1           | 0          | 'Notification' |
            | 'Comment'    | 1        | 1          | 0          | 350   | 1        | 1        | 0        | 'STRING'   | 1           | 0          | 'Notification' |
            | 'ValidID'    | 1        | 1          | 1          | 150   | 1        | 1        | 0        | 'STRING'   | 1           | 0          | 'Notification' |
            | 'CreateTime' | 1        | 1          | 0          | 150   | 1        | 1        | 0        | 'DATETIME' | 1           | 0          | 'Notification' |
            | 'CreateBy'   | 1        | 1          | 0          | 150   | 1        | 1        | 0        | 'STRING'   | 1           | 0          | 'Notification' |
            | 'ChangeTime' | 1        | 1          | 0          | 150   | 1        | 1        | 0        | 'DATETIME' | 1           | 0          | 'Notification' |
            | 'ChangeBy'   | 1        | 1          | 0          | 150   | 1        | 1        | 0        | 'STRING'   | 1           | 0          | 'Notification' |