...
Feature: Als Nutzer möchte ich eine korrekte Standardkonfiguration für eine Tabelle erhalten
    ...
    Scenario Outline: Tabelle mit korrekter Spalte <column>
        ...
        Examples:
            ...
            | 'Host'       | 1        | 1          | 0          | 200   | 1        | 1        | 0        | 'STRING'   | 1           | 0          | 'MailAccount' |
            | 'Login'      | 1        | 1          | 0          | 150   | 1        | 1        | 0        | 'STRING'   | 1           | 0          | 'MailAccount' |
            | 'Type'       | 1        | 1          | 0          | 150   | 1        | 1        | 0        | 'STRING'   | 1           | 0          | 'MailAccount' |
            | 'Comment'    | 1        | 1          | 0          | 350   | 1        | 1        | 0        | 'STRING'   | 1           | 0          | 'MailAccount' |
            | 'ValidID'    | 1        | 1          | 1          | 150   | 1        | 1        | 0        | 'STRING'   | 1           | 0          | 'MailAccount' |
            | 'CreateTime' | 1        | 1          | 0          | 150   | 1        | 1        | 0        | 'DATETIME' | 1           | 0          | 'MailAccount' |
            | 'CreateBy'   | 1        | 1          | 0          | 150   | 1        | 1        | 0        | 'STRING'   | 1           | 0          | 'MailAccount' |
            | 'ChangeTime' | 1        | 1          | 0          | 150   | 1        | 1        | 0        | 'DATETIME' | 1           | 0          | 'MailAccount' |
            | 'ChangeBy'   | 1        | 1          | 0          | 150   | 1        | 1        | 0        | 'STRING'   | 1           | 0          | 'MailAccount' |