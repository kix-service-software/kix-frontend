...
describe('Valid Service', () => {
    ...
    before(async () => {
        ...
        validService = container.getDIContainer().get<IValidObjectService>("IValidObjectService");
    ...
    describe('Get multiple ValidObjects', () => {
        ...
        describe('Create a valid request to retrieve a limeted list of ValidObjects which where changed after defined date.', () => {
